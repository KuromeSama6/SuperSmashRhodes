...
namespace SuperSmashRhodes.Util {
    ...
    public class UDictionary {
        ...
        public class Drawer : PropertyDrawer {
            ...
            public override void OnGUI(Rect rect, SerializedProperty property, GUIContent label) {
                label.text = $" {label.text} (UDictionary)";
    ...
    public static class UDictionaryUtil {
        public static UDictionary<Tk, Tv> EmptyFromEnum<Tk, Tv>() where Tk : Enum {
            var ret = new UDictionary<Tk, Tv>();
            foreach (var item in Enum.GetValues(typeof(Tk))) ret[(Tk) item] = default;
            return ret;
