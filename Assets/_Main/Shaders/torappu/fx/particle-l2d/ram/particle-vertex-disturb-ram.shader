Shader "Torappu/Particles-L2D/Ram/VertexDisturb(CustomData)" {
	Properties {
		...
		[Header(VertexDisturb)] _VertexDisturbTex ("Vertex Disturb Texture", 2D) = "black" {}
		_VertexDisturbWeightTex ("Vertex Disturb Weight Texture", 2D) = "white" {}
		_VertexDisturbIntensity ("Vertex Disturb Intensity", Vector) = (0,0,0,0)
		_VertexDisturbUSpeed ("Vertex Disturb U Speed", Float) = 0
		_VertexDisturbVSpeed ("Vertex Disturb V Speed", Float) = 0
	}
